...
Ошибка излома оценивается как дисперсия суммы 2 нормальных с.в. (независимых углов наклона с обоих сторон от излома) с дисперсией 0.25, т.е. равна 0.5. Чтобы оценить суммарную ошибку для сложного тренда надо ошибку излома умножить на ожидание к-во изломов, т.е., если длина ряда, по котрой строится предсказание -- n = 600, то ![](https://latex.codecogs.com/gif.latex?n/%5Clambda). и после усреднения получаем формулу ![](https://latex.codecogs.com/gif.latex?2%5Csigma_a%5E2/%5Clambda) (так как строим предсказание для трёхста точек).
